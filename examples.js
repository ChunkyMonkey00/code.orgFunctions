...
onEvent("btn", "click", function () {
    ...
    clearCanvas();
    var imageData = getImageDataAt(0, 0, 100, 100);
    setRed(imageData, 50, 50, 255);
    putImageDataAt(imageData, 0, 0);
    var pixelData = getImageDataAt(0, 0, 1, 1);
    var redComponent = getRed(pixelData, 0, 0);
    var greenComponent = getGreen(pixelData, 0, 0);
    var blueComponent = getBlue(pixelData, 0, 0);
    setRed(pixelData, 0, 0, 128);
